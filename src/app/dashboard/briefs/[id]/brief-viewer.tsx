...
import { Brief } from "@/lib/brief-storage" // Assuming Brief type is exported
import { useRouter } from "next/navigation"
import CompanionMode from "@/components/companion-mode"
import CrmExportModal from "@/components/crm-export-modal"
...
${brief.buyerIntentSignals}
  ...
  return (
    <div>
      ...
      {/* Companion Mode and CRM Export Modals */}
      {showCompanionMode && (
        <CompanionMode 
          briefId={brief.id} 
          onClose={() => setShowCompanionMode(false)} 
        />
      )}
